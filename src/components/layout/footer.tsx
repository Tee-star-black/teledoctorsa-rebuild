    ...
    <footer className={styles.footer}>
      <div className={styles.shell}>
        <div className={styles.topGrid}>
          <div className={styles.column}>
            <Link href="/" className={styles.footerLogoLink} aria-label="TeleDoctorSA home">
              <Image src="/images/home/logo.png" alt="TeleDoctorSA" width={300} height={96} className={styles.footerLogoSource} />
              <span className={styles.footerLogoLight} aria-hidden="true" />
            </Link>
          ...
          <div className={styles.column}>
            <div className={styles.metaBlock}>
              ...
              <Link href="/for-clinicians/register" className={styles.smallLink}>Clinician onboarding</Link>
            </div>
            <div className={styles.metaBlock}>
            ...
            <div className={styles.metaBlock}>
              ...
              <Link href="/demo" className={styles.smallLink}>Book a demo</Link>
            </div>
          </div>
        ...
        <div className={styles.emergency} role="note" aria-label="Emergency care disclaimer">
          ...
          <span>This website is not an emergency medical service. If you are experiencing a medical emergency, contact your local emergency service or go to the nearest appropriate emergency department.</span>
        </div>

        <div className={styles.brandStage} aria-hidden="true">
          <div className={styles.brandWordmark}><span className={styles.footerBrandMark} /><span className={styles.brandText}>TeleDoctorSA</span></div>
        </div>
      </div>
    </footer>
  );
